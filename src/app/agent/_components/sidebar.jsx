    ...
    return (
      <Sheet open={open} onOpenChange={setOpen} {...props}>
        <SheetContent
          ...
          className={cn(
            "w-[--sidebar-width] bg-sidebar-gradient p-0 text-sidebar-foreground [&>button]:hidden",
            !isMobile && "hidden md:block" // Show on desktop too
          )}
          style={{
          ...
          side={side}
        >
          <div className="absolute top-0 left-0 w-[15vw] h-full bg-white rounded-br-[100%]  rounded-tr-[0%] shadow-md mb-12"></div>

          <div className="relative h-full">
            <Button
              onClick={() => setOpen(false)}
              className=" ml-6 mt-28 rounded-lg p-2 hover:bg-gray-100" // Added ml-2 for left margin and increased padding
            >
              <X className="h-5 w-6 text-gray-700" />
            </Button>
